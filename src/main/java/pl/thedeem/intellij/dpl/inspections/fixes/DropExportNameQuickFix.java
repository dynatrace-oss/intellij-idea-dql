...
public class DropExportNameQuickFix extends AbstractDropListedElementQuickFix {
    public DropExportNameQuickFix() {
        super(DPLTypes.COLON);
    }

    @Override
    public @IntentionName @NotNull String getName() {
        return DPLBundle.message("inspection.fix.drop.exportName");
    }
