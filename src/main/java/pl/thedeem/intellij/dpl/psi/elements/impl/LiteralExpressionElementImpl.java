...
public abstract class LiteralExpressionElementImpl extends DPLSimpleExpressionImpl implements LiteralExpressionElement {
    private CachedValue<ExpressionDescription> definition;

    public LiteralExpressionElementImpl(@NotNull ASTNode node) {
        super(node);
    }
    ...
    public ItemPresentation getPresentation() {
        return new StandardItemPresentation(DPLBundle.message("presentation.stringExpression"), this, DPLIcon.LITERAL);
    }
