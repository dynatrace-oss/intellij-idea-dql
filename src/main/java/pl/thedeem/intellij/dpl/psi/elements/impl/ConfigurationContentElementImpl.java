...
public abstract class ConfigurationContentElementImpl extends ASTWrapperPsiElement implements ConfigurationElement {
    public ConfigurationContentElementImpl(@NotNull ASTNode node) {
        super(node);
    }
