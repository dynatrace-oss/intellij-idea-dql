...
public class DQLQueryExecutionComponent {
    ...
    public DQLQueryExecutionComponent() {
        ...
        String message = DQLBundle.message("components.popupMenu.actions.paste");
        defaultScanLimit.setComponentPopupMenu(createDefaultPopupMenu(message));
        maxResultBytes.setComponentPopupMenu(createDefaultPopupMenu(message));
        maxResultRecords.setComponentPopupMenu(createDefaultPopupMenu(message));
    ...
    private JPopupMenu generateTimestampPopupMenu(JBTextField field) {
        JPopupMenu popupMenu = createDefaultPopupMenu(DQLBundle.message("components.popupMenu.actions.paste"));
    ...
    private @NotNull JBPopupMenu createDefaultPopupMenu(@NotNull String message) {
        JBPopupMenu popupMenu = new JBPopupMenu();

        JBMenuItem pasteAction = new JBMenuItem(new DefaultEditorKit.PasteAction());
        pasteAction.setIcon(AllIcons.Actions.MenuPaste);
        pasteAction.setText(message);
