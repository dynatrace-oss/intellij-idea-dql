...
public final class Parameter {
    ...
    public List<String> valueTypes() {
        return Objects.requireNonNullElseGet(valueTypes, List::of);
    }

    public List<String> parameterValueTypes() {
        return Objects.requireNonNullElseGet(parameterValueTypes, List::of);
    }

    public List<String> allowedEnumValues() {
        return Objects.requireNonNullElseGet(allowedEnumValues, List::of);
    }
    ...
    public List<ParameterModifier> modifiers() {
        return Objects.requireNonNullElseGet(modifiers, List::of);
    }

    public List<String> aliases() {
        return Objects.requireNonNullElseGet(aliases, List::of);
    }
    ...
    public List<String> excludes() {
        return Objects.requireNonNullElseGet(excludes, List::of);
    }
