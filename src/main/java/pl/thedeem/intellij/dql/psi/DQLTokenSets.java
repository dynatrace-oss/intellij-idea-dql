...
public interface DQLTokenSets {
    ...
    TokenSet NUMBERS = TokenSet.create(DQLTypes.POSITIVE_DOUBLE, DQLTypes.POSITIVE_LONG, DQLTypes.NUMBER, DQLTypes.POSITIVE_SCIENTIFIC_NOTATION, DQLTypes.HEX_NUMBER);
