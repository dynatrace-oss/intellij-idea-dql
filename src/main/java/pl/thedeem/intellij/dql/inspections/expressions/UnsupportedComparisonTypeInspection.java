...
public class UnsupportedComparisonTypeInspection extends BaseInspection {
    @Override
    public @NotNull PsiElementVisitor buildVisitor(@NotNull ProblemsHolder holder, boolean isOnTheFly) {
        return new DQLVisitor() {
            ...
            public void visitComparisonExpression(@NotNull DQLComparisonExpression expression) {
                ...
                if (dataType.contains(DQLDataType.NULL)) {
                    ...
                    for (Map.Entry<BaseElement, Set<DQLDataType>> invalid : invalidSides.entrySet()) {
                        holder.registerProblem(invalid.getKey(), DQLBundle.message(
                                "inspection.comparison.unsupportedType.invalidType",
