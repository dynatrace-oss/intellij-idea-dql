...
public class DQLParsedQuery {
  ...
  public String getSubstitutedQuery(PsiFile psiFile) {
    ...
    WriteCommandAction.runWriteCommandAction(psiFile.getProject(), () -> {
      ...
      // collect the information about variables positions
  ...
  private record OffsetMapping(int originalStartOffset, int substitutedStartOffset, int originalLength, int substitutedLength) {
  }
