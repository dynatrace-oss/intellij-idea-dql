# Spec: dql-variables-schema

## Purpose

Defines how the plugin recognises `dql-variables.json` files, associates a bundled JSON schema with them, and surfaces schema violations to authors in the editor.
