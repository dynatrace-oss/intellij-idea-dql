# Spec: dql-variables-find-usages

## Purpose

Defines how Find Usages works when invoked on a variable definition property inside a `dql-variables.json` file, including scope rules and result categorisation.
